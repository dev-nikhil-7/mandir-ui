...
export default function ContributionsTable() {
  ...
  const filtered = contributions.filter(
    (c) =>
      ...
      c.tola_name.toLowerCase().includes(search.toLowerCase())
  );
          ...
          {paginated.length === 0 ? (
            ...
            paginated.map((c, index) => (
              ...
              >
                ...
                <td className="px-4 py-3">{c.tola_name}</td>
                <td className="px-4 py-3">{c.contributor_name}</td>
                <td className="px-4 py-3">
                  {getPaymentModeBadge(c.payment_mode)}
                </td>
                <td className="px-4 py-3">
